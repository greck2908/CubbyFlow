...
#ifndef FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_CUBBYFLOW_FBS_H_
#define FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_CUBBYFLOW_FBS_H_
...
inline flatbuffers::Offset<ScalarParticleData2> CreateScalarParticleData2Direct(
  ...
  return CubbyFlow::fbs::CreateScalarParticleData2(
      _fbb,
...
struct VectorParticleData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const CubbyFlow::fbs::Vector2D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const CubbyFlow::fbs::Vector2D *> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData2Builder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector2D *>> data) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector2D *>> data = 0) {
...
inline flatbuffers::Offset<VectorParticleData2> CreateVectorParticleData2Direct(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<const CubbyFlow::fbs::Vector2D *> *data = nullptr) {
...
inline flatbuffers::Offset<PointNeighborSearcherSerialized2> CreatePointNeighborSearcherSerialized2Direct(
  ...
  return CubbyFlow::fbs::CreatePointNeighborSearcherSerialized2(
      _fbb,
...
inline flatbuffers::Offset<ParticleNeighborList2> CreateParticleNeighborList2Direct(
  ...
  return CubbyFlow::fbs::CreateParticleNeighborList2(
      _fbb,
...
inline const CubbyFlow::fbs::ParticleSystemData2 *GetParticleSystemData2(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::ParticleSystemData2>(buf);
}

inline bool VerifyParticleSystemData2Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::ParticleSystemData2>(nullptr);
}

inline void FinishParticleSystemData2Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::ParticleSystemData2> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA2_CUBBYFLOW_FBS_H_
