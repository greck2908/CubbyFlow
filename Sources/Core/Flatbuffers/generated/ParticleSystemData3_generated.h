...
#ifndef FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_CUBBYFLOW_FBS_H_
#define FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_CUBBYFLOW_FBS_H_
...
inline flatbuffers::Offset<ScalarParticleData3> CreateScalarParticleData3Direct(
  ...
  return CubbyFlow::fbs::CreateScalarParticleData3(
      _fbb,
...
struct VectorParticleData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData3Builder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *>> data) {
...
inline flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Vector3D *>> data = 0) {
...
inline flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3Direct(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<const CubbyFlow::fbs::Vector3D *> *data = nullptr) {
  return CubbyFlow::fbs::CreateVectorParticleData3(
      _fbb,
      data ? _fbb.CreateVector<const CubbyFlow::fbs::Vector3D *>(*data) : 0);
}

struct MatrixParticleData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  enum {
    VT_DATA = 4
  };
  const flatbuffers::Vector<const CubbyFlow::fbs::Matrix3x3D *> *data() const {
    return GetPointer<const flatbuffers::Vector<const CubbyFlow::fbs::Matrix3x3D *> *>(VT_DATA);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct MatrixParticleData3Builder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_data(flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Matrix3x3D *>> data) {
    fbb_.AddOffset(MatrixParticleData3::VT_DATA, data);
  }
  MatrixParticleData3Builder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  MatrixParticleData3Builder &operator=(const MatrixParticleData3Builder &);
  flatbuffers::Offset<MatrixParticleData3> Finish() {
    const auto end = fbb_.EndTable(start_, 1);
    auto o = flatbuffers::Offset<MatrixParticleData3>(end);
    return o;
  }
};

inline flatbuffers::Offset<MatrixParticleData3> CreateMatrixParticleData3(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<const CubbyFlow::fbs::Matrix3x3D *>> data = 0) {
  MatrixParticleData3Builder builder_(_fbb);
  builder_.add_data(data);
  return builder_.Finish();
}

inline flatbuffers::Offset<MatrixParticleData3> CreateMatrixParticleData3Direct(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<const CubbyFlow::fbs::Matrix3x3D *> *data = nullptr) {
  return CubbyFlow::fbs::CreateMatrixParticleData3(
      _fbb,
      data ? _fbb.CreateVector<const CubbyFlow::fbs::Matrix3x3D *>(*data) : 0);
}
...
inline flatbuffers::Offset<PointNeighborSearcherSerialized3> CreatePointNeighborSearcherSerialized3Direct(
  ...
  return CubbyFlow::fbs::CreatePointNeighborSearcherSerialized3(
      _fbb,
...
inline flatbuffers::Offset<ParticleNeighborList3> CreateParticleNeighborList3Direct(
  ...
  return CubbyFlow::fbs::CreateParticleNeighborList3(
      _fbb,
...
struct ParticleSystemData3 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<MatrixParticleData3>> *matrixDataList() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MatrixParticleData3>> *>(VT_MATRIXDATALIST);
  }
...
struct ParticleSystemData3Builder {
  ...
  void add_matrixDataList(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MatrixParticleData3>>> matrixDataList) {
    fbb_.AddOffset(ParticleSystemData3::VT_MATRIXDATALIST, matrixDataList);
  }
...
inline flatbuffers::Offset<ParticleSystemData3> CreateParticleSystemData3(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MatrixParticleData3>>> matrixDataList = 0,
...
inline flatbuffers::Offset<ParticleSystemData3> CreateParticleSystemData3Direct(
    ...
    const std::vector<flatbuffers::Offset<MatrixParticleData3>> *matrixDataList = nullptr,
    flatbuffers::Offset<PointNeighborSearcherSerialized3> neighborSearcher = 0,
    const std::vector<flatbuffers::Offset<ParticleNeighborList3>> *neighborLists = nullptr) {
  return CubbyFlow::fbs::CreateParticleSystemData3(
      _fbb,
      radius,
      mass,
      positionIdx,
      ...
      matrixDataList ? _fbb.CreateVector<flatbuffers::Offset<MatrixParticleData3>>(*matrixDataList) : 0,
      neighborSearcher,
      neighborLists ? _fbb.CreateVector<flatbuffers::Offset<ParticleNeighborList3>>(*neighborLists) : 0);
}

inline const CubbyFlow::fbs::ParticleSystemData3 *GetParticleSystemData3(const void *buf) {
  return flatbuffers::GetRoot<CubbyFlow::fbs::ParticleSystemData3>(buf);
}

inline bool VerifyParticleSystemData3Buffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<CubbyFlow::fbs::ParticleSystemData3>(nullptr);
}

inline void FinishParticleSystemData3Buffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<CubbyFlow::fbs::ParticleSystemData3> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_PARTICLESYSTEMDATA3_CUBBYFLOW_FBS_H_
