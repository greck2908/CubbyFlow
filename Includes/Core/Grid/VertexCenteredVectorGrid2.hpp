...
#ifndef CUBBYFLOW_VERTEX_CENTERED_VECTOR_GRID2_HPP
#define CUBBYFLOW_VERTEX_CENTERED_VECTOR_GRID2_HPP
...
class VertexCenteredVectorGrid2 final : public CollocatedVectorGrid2
{
 public:
    ...
    VertexCenteredVectorGrid2() = default;

    //! Constructs a grid with given resolution, grid spacing, origin and
    //! initial value.
    VertexCenteredVectorGrid2(size_t resolutionX, size_t resolutionY,
    ...
    VertexCenteredVectorGrid2(VertexCenteredVectorGrid2&&) noexcept = delete;

    // Default virtual destructor.
    ~VertexCenteredVectorGrid2() override = default;
    ...
    VertexCenteredVectorGrid2& operator=(VertexCenteredVectorGrid2&&) noexcept =
        delete;
